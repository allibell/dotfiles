# Generated by Powerlevel10k configuration wizard on 2019-10-14 at 06:41 MDT.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 12090.
# Wizard options: awesome-fontconfig + powerline + python, large icons, lean, 2 lines,
...
() {
  ...
  ################################[ prompt_char: prompt symbol ]################################
  # Green prompt symbol if the last command succeeded or failed
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_{VIINS,VICMD,VIVIS}_FOREGROUND=255
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%77F'   # green foreground
      local   modified='%185F'  # yellow foreground
  ...
  # Use verbose signal names: "SIGINT(2)" instead of "INT".
  ...
  ###############################[ public_ip: public IP address ]###############################
  # Public IP color.
  typeset -g POWERLEVEL9K_PUBLIC_IP_FOREGROUND=87
  # Custom icon.
  # typeset -g POWERLEVEL9K_PUBLIC_IP_VISUAL_IDENTIFIER_EXPANSION='⭐'

  ########################[ vpn_ip: virtual private network indicator ]#########################
  # VPN IP color.
  typeset -g POWERLEVEL9K_VPN_IP_FOREGROUND=87
